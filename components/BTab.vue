...
<template>
  <HeadlessTabGroup>
    <HeadlessTabList class="w-full flex select-none border-1 border-black-200 rounded-full bg-white-100 shadow-[3px_3px_0px_0px_rgb(30,30,30)] md:w-[566px]">
      ...
      >
        <button
          class="w-full flex cursor-pointer items-center justify-center rounded-full px-2 py-1 text-black-200 transition-all duration-300 ease-out md:px-0 md:py-1.5 paragraph-bold-tab active:bg-red-700 focus:outline-none"
          :class="[
            activeTab === index
